...
| What | Where | As run |
|---|---|---|
| Modem serial port (J12 / DE-9) | `PORT` in `qa_common.py` | `COM15` |
| Debug UART port (J7) | `serial.Serial("COM5", ...)` in `qa_dtr2.py`, `qa_dcd.py` | `COM5` |
| PC's LAN address (TCP tests, modem dials the PC) | `PC_IP` in `qa_dcd.py`, `qa_dtrhangup.py`, `qa_latency.py`, `qa_stream2.py` | `192.168.1.140` |
...
| `qa_sweep.py` | Baud sweep 300-921600: AT answers, RTS holds/releases output at each rate | 50 |
